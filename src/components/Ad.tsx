...
const Ad = ({ size }: { size: "sm" | "md" | "lg" }) => {
  return (
    <div className="p-4 bg-white rounded-lg  shadow-md text-sm">
      ...
      {/*BOTTOM*/}
      <div
        className={`flex flex-col justify-between  mt-4 ${size === "sm" ? "gap-2" : "gap-4"}`}
      >
        <div
        ...
        >
          <Image
            src="https://images.pexels.com/photos/4755184/pexels-photo-4755184.jpeg?auto=compress&cs=tinysrgb&w=600"
            alt=""
            fill
